        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 18:
              ...
              return _context.abrupt("return", new _renderresult["default"](undefined, new _renderresult.OverflowContentError(errorMessage, [prevNode])));
            case 26:
            ...
            case 36:
              ...
              break;
            case 47:
              return _context.abrupt("return", new _renderresult["default"](undefined, new _renderresult.OverflowContentError(_errorMessage, [node])));
            case 48:
              length = 0;
            ...
            case 80:
              this.hooks && this.hooks.beforeRenderResult.trigger(undefined, wrapper, this);
              return _context.abrupt("return", new _renderresult["default"](undefined, new _renderresult.OverflowContentError(_errorMessage2, [node])));
            case 82:
              ...
              _errorMessage3 = "Unable to layout item";
              console.warn("".concat(_errorMessage3, ":"), node);
              this.error = {
                msg: _errorMessage3,
                item: node
              };
              _afterNode2 = newBreakToken.node ? (0, _dom.nodeAfter)(newBreakToken.node) : null;
              if (!_afterNode2) {
                _context.next = 95;
                break;
              }
              newBreakToken = new _breaktoken["default"](_afterNode2);
              _context.next = 97;
              break;
            case 95:
              this.hooks && this.hooks.beforeRenderResult.trigger(undefined, wrapper, this);
              return _context.abrupt("return", new _renderresult["default"](undefined, new _renderresult.OverflowContentError(_errorMessage3, [node])));
            case 97:
              _context.next = 7;
              break;
            case 99:
              ...
              return _context.abrupt("return", new _renderresult["default"](newBreakToken, new _renderresult.OverflowContentError(this.error.msg, this.error.item)));
            case 102:
              return _context.abrupt("return", new _renderresult["default"](newBreakToken));
            case 103:
            case "end":
