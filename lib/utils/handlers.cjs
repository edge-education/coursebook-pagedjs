...
var registeredHandlers = exports.registeredHandlers = [].concat((0, _toConsumableArray2["default"])(_index["default"]), (0, _toConsumableArray2["default"])(_index2["default"]), (0, _toConsumableArray2["default"])(_index3["default"]));
var Handlers = exports.Handlers = /*#__PURE__*/(0, _createClass2["default"])(function Handlers(chunker, polisher, caller) {
  var _this = this;
